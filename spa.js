   ...
   imagensCarrossel.forEach((img, index) => {
    ...
    return `
        <div class="animate-fade-in fixed top-0 left-0 w-full h-[100dvh] z-50 bg-slate-50 flex flex-col overflow-y-auto no-scrollbar">
            ...
            <div class="bg-white rounded-t-3xl -mt-6 relative z-30 px-5 pt-8 pb-4 flex-1 flex flex-col gap-4 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] border-t border-slate-100">
